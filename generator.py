<<< 'EOF' > ims_source/smali/android/telephony/TelephonyBaseUtilsStub.smali
...
.end method
EOF
apktool b ims_source -o ims-fixed.apk && java -jar uber-apk-signer.jar -a ims-fixed.apk --allowResign && mkdir -p tmp_ims/system/system_ext/priv-app/ims && cp ims-fixed-aligned-debugSigned.>
#!/system/bin/sh
MODDIR=${0%/*}
